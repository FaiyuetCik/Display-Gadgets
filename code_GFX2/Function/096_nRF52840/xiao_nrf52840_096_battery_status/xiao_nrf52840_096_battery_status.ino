/*
  XIAO nRF52840 Plus 0.96-inch Display - Battery Status Demo
  Library: Seeed_GFX2
...
// Same UI as 1.47-inch, scaled to fit the 80-pixel-wide panel.
...
// 0.96-inch trace: USB-only spread~150/CHG HIGH, settled cell spread~5-11/CHG LOW.
...
void setup() {
  ...
  if (!display.begin<Board_XIAO_0inch96_LCD<LCD_RST_PIN, LCD_BL_PIN>, Config_Seeed_0inch96_LCD_ST7789>()) {
