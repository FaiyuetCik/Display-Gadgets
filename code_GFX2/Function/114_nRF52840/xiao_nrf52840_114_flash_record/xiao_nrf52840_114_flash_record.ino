/*
  ...
  DROP driver.h + the manual bus/panel pin init inside initDisplay().
  Config_Seeed_1inch14_LCD_ST7789 bakes 135x240 RGB invert=true rot0.
  PDM capture, InternalFS WAV storage and NRF_I2S playback unchanged.
...
static void progressScreen(uint32_t samples) {
  ...
  display.fillRect(0, 36, LCD_W, 204, TFT_BLACK);
