/*
  ...
  DROP driver.h + preparePins/forceBacklightOn/hardResetPanel/initDisplay.
  Config_Seeed_1inch14_LCD_ST7789 bakes 135x240 RGB invert=true rot0.
  Benchmark drawing calls carry over 1:1 (tft -> display).
...
static void showTitle(const char *title) {
  ...
  display.drawString("XIAO nRF52840 Plus", display.width() / 2, 118, 1);
  delay(650);
}
...
static unsigned long testText() {
  ...
  display.drawString("Seeed_GFX2", 10, 88, 2);
