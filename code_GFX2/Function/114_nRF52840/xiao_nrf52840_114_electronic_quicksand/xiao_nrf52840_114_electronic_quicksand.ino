/*
  XIAO nRF52840 Plus 1.14 Inch Display electronic quicksand demo.

  This is the 1.14-inch version of the 1.47 electronic quicksand.
  Uses the same low-resolution occupancy-grid trick, with a smaller
  grid that fits the 135x240 ST7789 panel.

  Differences from the 1.47 version:
    - 135x240 resolution (vs 172x320)
    - No JD9853A panel fix needed (ST7789 IPS)
    - invertDisplay(true) instead of false
    - Smaller grid: 22x40, cell_size=6, 150 particles
  ...
  DROP driver.h + prepareDisplayPins/forceBacklightOn/hardResetPanel.
  Config_Seeed_1inch14_LCD_ST7789 bakes 135x240 RGB invert=true rot0.
  LSM6DS3 IMU (I2C) and particle physics unchanged.
...
// This 1.14-inch panel is physically wired for BGR color order.
// Keep the correction local to this sketch; do not modify Seeed_GFX2.
