 ...
 * Demo:    1.47 version of the quicksand sim on a 24x45 grid (ESP32-S3 IMU access
 *          code reused from the 1.14 build).
 *
 * Ported from XIAO-Display-Board-main (xiao_esp32s3_147_electronic_quicksand,
