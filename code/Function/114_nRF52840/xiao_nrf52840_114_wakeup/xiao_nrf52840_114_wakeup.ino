...
// ========================= LCD init (from graphictest, proven) =========================
...
static void drawAwakeLayout() {
  ...
  tft.drawFastHLine(4, 38, 127, C_LINE);

  // STATE card
  tft.drawRoundRect(4, 46, 127, 60, 5, C_CYAN);
  tft.setTextColor(C_CYAN, C_BLACK);
  tft.setCursor(14, 56);  tft.print("POWER STATE");
  tft.setTextColor(C_WHITE, C_BLACK);
  tft.setCursor(14, 72);  tft.print("Screen");
  tft.setCursor(14, 86);  tft.print("WakeCnt");

  // MOTION card
  tft.drawRoundRect(4, 112, 127, 70, 5, C_YELLOW);
  tft.setTextColor(C_YELLOW, C_BLACK);
  tft.setCursor(14, 122); tft.print("MOTION");
  tft.setTextColor(C_WHITE, C_BLACK);
  tft.setCursor(14, 138); tft.print("Acc");
  tft.setCursor(14, 152); tft.print("Gyr");
  tft.setCursor(14, 166); tft.print("INT");

  // TEST card
  tft.drawRoundRect(4, 188, 127, 34, 5, C_GREEN);
  tft.setTextColor(C_GREEN, C_BLACK);
  tft.setCursor(12, 198); tft.print("TEST");
  tft.setTextColor(C_WHITE, C_BLACK);
  tft.setCursor(12, 212); tft.print("U1 sleep  U2 wake");
}
