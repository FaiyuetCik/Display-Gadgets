/*
  XIAO ESP32-S3 Plus 1.14 Inch Display electronic quicksand demo.

  This is the 1.14-inch version of application/xiao_nrf52840_147_electronic_quicksand.
  It uses the same low-resolution occupancy-grid trick, but with a smaller
