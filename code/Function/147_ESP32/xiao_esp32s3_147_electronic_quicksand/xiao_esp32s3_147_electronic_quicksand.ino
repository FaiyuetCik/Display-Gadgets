/*
  XIAO ESP32-S3 Plus 1.47 Inch Display electronic quicksand demo.

  This is the ESP32-S3 version of application/xiao_nrf52840_147_electronic_quicksand.
  It keeps the 1.47-inch 24x45 low-resolution occupancy grid, and uses the
  ESP32-S3 IMU access code from the 1.14-inch version.
*/
...
static constexpr uint16_t SAND_PARTICLES = 180;
...
static void resetParticles() {
  ...
  clearOccupancy();
  for (int8_t y = GRID_H - 8; y < GRID_H && index < SAND_PARTICLES; ++y) {
...
void setup() {
  ...
  Serial.println();
  Serial.println("=== Electronic Quicksand ESP32-S3 1.47 ===");
