/*
  ...
  Factory Dashboard v2.7 - Direct USB PWR on Battery Removal
...
static constexpr uint8_t LCD_RST_PIN   = D17; // Schematic expected D17; current BSP workaround.
static constexpr uint8_t LCD_BL_PIN    = D18;
static constexpr uint8_t BTN_A_PIN     = D19; // Schematic expected D19; current BSP workaround.
